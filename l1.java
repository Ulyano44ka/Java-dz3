...
public class l1 {
    public static void main(String[] args) {
        ...
        System.out.println("Список A: " + fillAListOfRandom(alist1, 20));
        System.out.println("Список B: " + fillAListOfRandom(alist2, 20));
        System.out.printf("Сортированный по возрастанию методом sort класса Collections\n" + //копия списка 1, чтобы его потом можно было ещё раз отсортировать
                "список совпадающих элементов списков A и B ():\n%s\n", SortAList(deleteFromAList(alist1, alist2)));
        System.out.printf("Сортированный по убыванию методом sort списка и компаратором список B:\n%s\n", SortAListComparator(alist2));
        System.out.printf("Сортированный по возрастанию пузырьковым методом список A:\n%s\n", SortAListBubble(alist1));
    }
